...
class Vrf:
    ...
    logger = utils.get_logger_for_name('updaters.vrf')

    @staticmethod
    def update(vrf: dict, password: str) -> bool:
        """
        Using the JunOS python library, this method attempts to update a Virtual Router in a Physical Router using the
        config passed in from the dispatcher, and reports back to the dispatcher whether or not the update succeeded
