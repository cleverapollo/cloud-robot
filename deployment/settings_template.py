...
Robot Database
"""
CLOUDCIX_LOCK_HOST = os.getenv('CLOUDCIX_LOCK_HOST', 'pgsqllocks')
CLOUDCIX_LOCK_CREDENTIALS = os.getenv('CLOUDCIX_LOCK_CREDENTIALS', 'pw')
CLOUDCIX_LOCK_PORT = os.getenv('CLOUDCIX_LOCK_PORT', '5432')
CLOUDCIX_LOCK_USER = os.getenv('CLOUDCIX_LOCK_USER', 'postgres')
